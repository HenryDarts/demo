                        ...
                        <div class="team-content">
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <div class="team-details">
                                        <h4 class="team-name">
                                            <a data-toggle="modal" data-target="#md15">ხმელეთის ეკოსისტემების დაცვა, აღდგენა და მდგრადი გამოყენება, ტყის მდგრადი მართვა</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="team-content">
                            <div class="display-table">
                                <div class="display-table-cell">
                                    <div class="team-details">
                                        <h4 class="team-name">
                                            <a data-toggle="modal" data-target="#md16">მშვიდობიანი და ინკლუზიური საზოგადოების ჩამოყალიბების ხელშეწყობა მდგრადი განვითარებისათვის, მართლმსაჯულებაზე ხელმისაწვდომობის უზრუნველყოფა ყველასათვის</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
